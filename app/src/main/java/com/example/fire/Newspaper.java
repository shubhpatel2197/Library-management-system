...
public class Newspaper extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter adapter = new ArrayAdapter(Newspaper.this, android.R.layout.simple_list_item_1, namelist);
        ...
        SV.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                if(namelist.contains(query)){
                    ...
                    Toast.makeText(Newspaper.this, "No Match found", Toast.LENGTH_LONG).show();
                }
                return false;
            }
